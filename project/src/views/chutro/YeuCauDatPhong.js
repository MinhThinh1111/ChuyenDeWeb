...
import { getListYeuCauDatPhongCallAPI } from '../../services/admin/KietService';
...
class YeuCauDatPhong extends React.Component {
    ...
    async componentDidMount() {
        ...
        let res = await getListYeuCauDatPhongCallAPI(idTaiKhoan);
        if (res != null) {
            this.setState({
                listYeuCauById: res
            })
    ...
    render() {
        let { listYeuCauById, tenChuTro } = this.state
        return (
            <>
                ...
                <div class="section trending">
                    <div class="container">
                        <div class="row trending-box">
                            {
                                listYeuCauById.length == 0 ? <div className='null'>Chưa có yêu cầu đặt phòng nào</div> :
                                    <div>
                                            ...
                                            return (
                                                <div class="col-lg-12 col-md-6 align-self-center mb-30 trending-items col-md-6">
                                                        ...
                                                        <div class="down-content">
                                                            ...
                                                            <br />
                                                            <span class="category">Mã phòng {item.phong.id}</span>

                                                            <h4>{item.nguoiThue.ten}</h4>
                                                            <NavLink to={`/chutro/yeucaudetail?id=${item.id}`} ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
