...
import {
  ...
  getNguoiThueById,
  updatePassWord,
} from "../../services/nguoithue/ThinhService";
import { async } from "q";
import { ToastContainer, toast } from "react-toastify";
import { useNavigate } from "react-router";

function EditPassWordNguoiThue() {
  ...
  return (
    <>
      <Header tenManHinh={"Đổi mật khẩu"} tenNguoiThue={result.ten} />
      <ToastContainer
        position="top-right"
        autoClose={1000}
...
export default EditPassWordNguoiThue;
